...
def main(args):
    ...
    zeroshot_weights = zeroshot_classifier(model, food101_classes, imagenet_templates)
    total_num = 0
    true_num = 0
...
if __name__ == "__main__":
    ...
    args.add_argument('-d', '--data-dir', default='/mnt/cpfs-data/datasets/Food101', type=str,
