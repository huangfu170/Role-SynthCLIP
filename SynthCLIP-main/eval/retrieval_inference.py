...
if __name__ == "__main__":
    config = {
        "model_path": "/mnt/cpfs-data/huangfuyuanxiang/models/clip-vit-base-patch16",  # 本地预训练模型路径
        "train_csv_path": "/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/data/sharedGPT4V.csv",    # 训练数据CSV文件
        "test_csv_path": "/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/data/coco2017val_qwenvl_caption_short.csv",      # 测试数据CSV文件
        "coco_test_csv_path":"/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/data/coco_official.csv",
        "train_images_folder": "/mnt/cpfs-data/huangfuyuanxiang/datasets/sharedGPT4V",            # 图片存放的根目录
        "test_images_folder": "/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/images/val2017",            # 图片存放的根目录
        "coco_test_image_folder":"/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/images/val2017",
        "flickr_image_folder":"/mnt/cpfs-data/huangfuyuanxiang/datasets/Flickr30K/test/images_flickr_1k_test",
        "flickr_test_csv_path":"/mnt/cpfs-data/huangfuyuanxiang/scripts/train/clip_train/data/flickr_official.csv",
        "num_epochs": 20,                         # 训练轮次
